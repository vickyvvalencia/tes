  ...
  <div class="container py-3">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item ">
          <a class="nav-link fs-5" aria-current="page" href="<?= URL::to('/')?>/">Home</a>
        </li>
        
        <li class="nav-item ">
          <a class="nav-link fs-5" href="<?= URL::to('/')?>/login">Login</a>
        </li>
        <li class="nav-item ">
          <a class="nav-link fs-5" href="<?= URL::to('/')?>/register">Register</a>
        </li>
      </ul>
    </div>
  </div>
